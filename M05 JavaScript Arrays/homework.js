...
function empiezaConNueve(num) {
   ...
   // return num.toString().startWith('9'); se cambia el numero a string
}
...
function tablaDelSeis() {
   ...
   for(let i = 0; i <= 10; i++) { //determinamos el limite del array con 10
      multiplos.push(i * 6);
   }
   return multiplos;
}
...
function breakStatement(num) {
   ...
   if(nuevoArray.length < 10) return 'Se interrumpió la ejecución';
   return nuevoArray;
}
